...
export default class ArchiveDownloader {
     ...
     * @returns
     */
    async downloadArchive(name, url) {
        ...
        try {
            ...
            if (res.ok && res.body !== null) {
                ...
                throw new Error("Unable to download " + name + ".zip: " + res.statusText);
            }
        }
        return zipFile;
    }
     ...
     * @param zipFile
     */
    async unzipArchive(name, zipFile) {
        ...
        try {
            ...
            await pipeline(rs, unzip, new stream.Transform({
                objectMode: true,
...
//# sourceMappingURL=ArchiveDownloader.js.map